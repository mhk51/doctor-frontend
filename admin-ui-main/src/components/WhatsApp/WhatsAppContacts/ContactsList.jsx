...
const ContactsList = ({ onPatientClick }) => {
  ...
  const filteredPatients = sortedPatients.filter((patient) => {
    ...
    const mrn = patient.mrn ? String(patient.mrn) : ''; // Convert MRN to a string for comparison
  
    return (
      firstName.includes(searchQuery.toLowerCase()) ||
      lastName.includes(searchQuery.toLowerCase()) ||
      mrn.includes(searchQuery)
    );
  });
        ...
        {filteredPatients.map((patient, index) => (
          ...
          >
            ...
            <div className="contact-details">
              <div className="contact-name">{`${patient.first_name} ${patient.last_name}`}</div>
